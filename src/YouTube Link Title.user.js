...
function onLoad() {
	...
	cfg.load();
	var q = 'a[href*="//web.archive.org/web/20190216065913/https://t.co/"]';
...
var sites = {
	'yt':{
		...
		embed:function(vid, t) { var m = /((\d+)h)?((\d+)m)?(\d+)?/.exec(t); t = parseInt(m[2] || 0)*3600 + parseInt(m[4] || 0)*60 + parseInt(m[5] || 0); return 'https://web.archive.org/web/20190216065913/https://www.youtube.com/embed/' + vid + '?autoplay=1&rel=1' + (t ? '&start=' + t : ''); },
		url:function(vid, t, oUrl) { return 'https://web.archive.org/web/20190216065913/https://www.youtube.com/watch?v=' + vid + (/\b(list=[a-z0-9_-]+)/i.exec(oUrl) ? '&' + RegExp.$1 : '') + (t ? '#t=' + t : ''); },
		preview:function(vid) { return 'https://web.archive.org/web/20190216065913/https://img.youtube.com/vi/' + vid + '/0.jpg'; },
	...
	'vm':{
		...
		sizes:[[640,360],[853, 480]],
		embed:function(vid, t) { return 'https://web.archive.org/web/20190216065913/https://player.vimeo.com/video/' + vid + '?title=1&portrait=1&byline=1&color=aa0000&autoplay=1'; },
		url:function(vid, t) { return 'https://web.archive.org/web/20190216065913/https://vimeo.com/' + vid; },
		...
		request:function(vid, f) {
			net.json('https://web.archive.org/web/20190216065913/https://vimeo.com/api/oembed.json?url=http://vimeo.com/' + vid, function(code, obj) {
				if(code == 404) {
					window.setTimeout(f, 0, {title:'Video not found', status:4});
				} else if(code == 403) {
	...
	'vn':{
		...
		embed:function(vid) { return 'https://web.archive.org/web/20190216065913/https://vine.co/v/' + vid + '/card?audio=1'; },
		url:function(vid) { return 'https://web.archive.org/web/20190216065913/https://vine.co/v/' + vid; },
		...
		request:function(vid, f) {
			net.text('https://web.archive.org/web/20190216065913/https://vine.co/v/' + vid, [/"og:title" content="(.+?)">/, /"og:image" content="(.+?)"/], function(code, m) {
	...
	'll':{
		...
		embed:function(vid) { return 'https://web.archive.org/web/20190216065913/https://www.liveleak.com/ll_embed?i=' + vid + '#play'; },
		url:function(vid) { return 'https://web.archive.org/web/20190216065913/https://www.liveleak.com/view?i=' + vid; },
		...
		request:function(vid, f) {
			net.text('https://web.archive.org/web/20190216065913/https://www.liveleak.com/view?i=' + vid, [/Item not found!/i, /<title>LiveLeak\.com - (.+?)<\/title>/i, /"og:image" content="(.+?)"/], function(code, m) {
	...
	'wh':{
		...
		embed:function(vid) { return 'https://web.archive.org/web/20190216065913/http://www.worldstarhiphop.com/videos/ea/16711680/' + vid; },
		url:function(vid) { return 'https://web.archive.org/web/20190216065913/http://www.worldstarhiphop.com/videos/video.php?v=' + vid; },
		...
		request:function(vid, f) {
			net.text('https://web.archive.org/web/20190216065913/http://www.worldstarhiphop.com/videos/video.php?v=' + vid, [/<title>(Video: )?(.+?)\s*(\(\*Warning|<\/title>)/i, /"image_src" href="(.+?)"/], function(code, m) {
				var title = m[0], preview = m[1];
				if(title) {
	...
	'dm':{
		...
		embed:function(vid, t) { return 'https://web.archive.org/web/20190216065913/https://www.dailymotion.com/embed/video/' + vid + '?logo=0&autoplay=1' + (t ? '&start=' + t : ''); },
		url:function(vid, t) { return 'https://web.archive.org/web/20190216065913/https://www.dailymotion.com/video/' + vid + (t ? '?start=' + t : ''); },
		...
		request:function(vid, f) {
			net.json('https://web.archive.org/web/20190216065913/https://www.dailymotion.com/services/oembed?format=json&url=http://www.dailymotion.com/video/' + vid, function(code, obj) {
				if(code == 404) {
					window.setTimeout(f, 0, {title:'Video not found', status:4});
				} else if(code == 200 && obj) {
					window.setTimeout(f, 0, {title:obj.title ? obj.title : 'Unknown video', preview:obj.thumbnail_url});
	...
	'cb':{
		...
		sizes:[[640,360],[853,480]],
		embed:function(vid, t) { return 'https://web.archive.org/web/20190216065913/https://coub.com/embed/' + vid + '?muted=false&autostart=true&noSiteButtons=true'; },
		url:function(vid, t) { return 'https://web.archive.org/web/20190216065913/https://coub.com/view/' + vid; },
		...
		request:function(vid, f) {
			net.json('https://web.archive.org/web/20190216065913/https://coub.com/api/oembed.json?url=http://coub.com/view/' + vid, function(code, obj) {
				if(code == 404) {
					window.setTimeout(f, 0, {title:'Video not found', status:4});
				} else if(code == 403) {
					window.setTimeout(f, 0, {title:'Unknown video', status:5});
	...
	'vd':{
		...
		sizes:[[640,360],[853,480]],
		embed:function(vid, t) { return 'https://web.archive.org/web/20190216065913/https://vid.me/e/' + vid + '?autoplay=1'; },
		url:function(vid, t) { return 'https://web.archive.org/web/20190216065913/https://vid.me/' + vid; },
		...
		request:function(vid, f) {
			net.text('https://web.archive.org/web/20190216065913/https://vid.me/' + vid, [/"og:title" content="(.+?)">/, /"og:image" content="(.+?)"/], function(code, m) {
				var title = m[0], preview = m[1];
				if(code == 404) {
					window.setTimeout(f, 0, {title:'Video not found', status:4});
				} else {
	...
	'st':{
		...
		embed:function(vid, t) { return 'https://web.archive.org/web/20190216065913/https://streamable.com/e/' + vid + '?autoplay=1'; },
		url:function(vid, t) { return 'https://web.archive.org/web/20190216065913/https://streamable.com/' + vid; },
		...
		request:function(vid, f) {
			net.text('https://web.archive.org/web/20190216065913/https://streamable.com/' + vid, [/<h1[^>]*>(.+?)</, /"og:image" content="(.+?)"/], function(code, m) {
				var title = m[0], preview = m[1];
				if(code == 404) {
					window.setTimeout(f, 0, {title:'Video not found', status:4});
				} else {
...
var cfg = {
	settings: {
		country: { title:'Check for restrictions? Enter your <a href="https://web.archive.org/web/20190216065913/http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#Officially_assigned_code_elements" target="_blank" style="text-decoration:underline!important;" title="e.g. US, GB or DE">country code</a>', default:'', maxlength:2},
...
/*
     FILE ARCHIVED ON 06:59:13 Feb 16, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 23:34:15 Jan 27, 2022.
...
/*
playback timings (ms):
  captures_list: 94.786
  exclusion.robots: 0.086
  exclusion.robots.policy: 0.079
  RedisCDXSource: 0.777
  esindex: 0.008
  LoadShardBlock: 69.492 (3)
  PetaboxLoader3.datanode: 72.955 (4)
  CDXLines.iter: 21.731 (3)
  load_resource: 86.055
  PetaboxLoader3.resolve: 44.558
*/